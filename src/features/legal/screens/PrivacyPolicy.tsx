import { termsOfPolicyContent } from '../data/privacyPolicy';
    ...
    <div className="md:py-8 py-6">
      <div className="space-y-8">
        {/* <div className="text-center space-y-4">
          <h1 className="font-bold md:!text-3xl !text-2xl">Privacy Policy</h1>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: termsOfPolicyContent }}
        />
      </div>
    </div>
  );
